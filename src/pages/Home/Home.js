...
const Home = () => {
    return (
        <main className="m-auto w-full flex flex-col justify-center">
            <section>
                <div>
                    <picture className="relative">
                        ...
                        <div className="tablet:block hidden absolute bottom-0 left-0 bg-white h-80 max-w-md pt-14 pr-14">
            ...
            <section>
                <div className="flex justify-between mt-10 tablet:flex-wrap">
